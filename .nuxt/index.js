...
import nuxt_plugin_meta_0b047550 from 'nuxt_plugin_meta_0b047550' // Source: ./pwa/meta.js (mode: 'all')
import nuxt_plugin_icons_44372dd7 from 'nuxt_plugin_icons_44372dd7' // Source: ./pwa/icons.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"docker-nuxt","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_meta_0b047550 === 'function') {
    await nuxt_plugin_meta_0b047550(app.context, inject)
  }

  if (typeof nuxt_plugin_icons_44372dd7 === 'function') {
    await nuxt_plugin_icons_44372dd7(app.context, inject)
  }
